...
- 支持应用内版本更新，默认读取 GitHub 更新清单，展示版本说明并可一键更新容器，失败时显示原因。
...
- `0.9.96`
- 更新说明：优化应用内更新稳定性；更新失败时显示明确原因；固定版本镜像会提示手动更新。
- Digest: `sha256:03185942428e0839a72227b3a5e46cc40e0d1740c7e18281a6dfb469c4fbe508`
